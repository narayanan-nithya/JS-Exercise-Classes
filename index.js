...
class Car {
  ...
  drive(distance){
    const drivenmiles = this.tank * this.mpg;
    if(distance < drivenmiles){
      this.odometer = this.tank + distance;
...
const mercedes = new Car('Mercedes Sprinter', 55);
mercedes.fill(17);
...
console.log(teacher.grade('Abigail', 'Python'));
/*
  TASK 5
